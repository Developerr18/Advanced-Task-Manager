const TaskColumns = () => {
  return (
    <div className="flex gap-4 items-center flex-wrap">
      ...
      <button className="cursor-pointer px-4 py-2 bg-gray-100 text-gray-700 rounded-lg border-2 border-gray-300 font-semibold hover:bg-gray-200 transition-colors">
        Clear Filters
      </button>
    </div>
  );
